...
class ParimutuelServiceTest {
    ...
    fun getPayoutPreview_emptyPool_returnsAmount() = runTest {
        ...
        // hypothetical 100 into poolA (0): newPoolTotal=100, newGrandTotal=400
        // payout = (100/100)*400 = 400
        val payout = service.getPayoutPreview(eventId, poolAId, 100)
    ...
    @Test
    fun getCurrentPayout_poolAmountZero_returnsZero() = runTest {
    ...
    fun getCurrentPayout_formulaCheck() = runTest {
        ...
        // stake=100, pool=200, grandTotal=500 → (100/200)*500 = 250
    ...
    fun resolveEvent_paysOutWinnersProportionally() = runTest {
        ...
        // grandTotal=500, poolA=200, each stake=100 → payout=(100/200)*500=250
